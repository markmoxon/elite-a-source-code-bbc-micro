...
PUTFILE "output/ELITE", "ELITE", &FF1900, &FF197B

PUTFILE "output/1.D", "1.D", &FF11E3, &FF11E3
PUTFILE "output/1.E", "1.E", &FF11E3, &FF11E3
PUTFILE "output/1.F", "1.F", &FF11E3, &FF11E3

PUTFILE "output/2.H", "2.H", &FF1200, &FF1200
PUTFILE "output/2.T", "2.T", &001000, &002E93
